...
public class AcqRelNode extends EventNode {
	...
	public AcqRelNode(long eventNumber, ShadowLock shadowLock, int threadID, boolean isAcquire, AcqRelNode inCS, String sourceLoc) {
		super(eventNumber, threadID, inCS, sourceLoc);
	...
	public String getNodeLabel(){
		return (isAcquire ? "acq" : "rel") + "(" + Util.objectToIdentityString(shadowLock.getLock()) + ")";
	}
}
