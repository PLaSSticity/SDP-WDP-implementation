...
public class RdWrNode extends EventNode {
	...
	public RdWrNode(long eventNumber, boolean isWrite, WDCGuardState var, int threadID, AcqRelNode currentCriticalSection, String sourceLoc) {
		super(eventNumber, threadID, currentCriticalSection, sourceLoc);
		this.var = var.getID();
		this.isWrite = isWrite;
	}
	public RdWrNode(long eventNumber, boolean isWrite, WDCVolatileData var, int threadID, AcqRelNode currentCriticalSection, String sourceLoc) {
		super(eventNumber, threadID, currentCriticalSection, sourceLoc);
		this.var = var.getID();
		this.isWrite = isWrite;
	}
