...
class WCPRELockState extends LockState {
	//Rule(c)
	public final VectorClock hb;
	...
	public WCPRELockState(ShadowLock peer, int size) {
		super(peer, size);
...
class DCRELockState extends LockState {
	//Rule(a)
	public VectorClock Cm;
	...
	public DCRELockState(ShadowLock peer, int size) {
		super(peer, size);
		this.Cm = new VectorClock(size);
	}
}

class WDPLockState extends LockState {
	//Rule(a)
	public VectorClock Cm;
	...
	public WDPLockState(ShadowLock peer, int size) {
		super(peer, size);
		this.Cm = new VectorClock(size);
	}
}

class CAPOLockState extends LockState {
	//Rule(a)
	public HashSet<ShadowVar> readVars = new HashSet<ShadowVar>();
	public HashSet<ShadowVar> writeVars = new HashSet<ShadowVar>();
	public WeakIdentityHashMap<ShadowVar,VectorClock> WriteMap = new WeakIdentityHashMap<ShadowVar,VectorClock>();
	...
	public CAPOLockState(ShadowLock peer, int size) {
		super(peer, size);
	}
}

class CAPORELockState extends LockState {
	//Rule(a)
	public VectorClock Cm;
	
	public CAPORELockState(ShadowLock peer, int size) {
		super(peer, size);
		this.Cm = new VectorClock(size);
	}
}